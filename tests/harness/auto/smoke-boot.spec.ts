 ...
 *
 * Scenario:  smoke-boot
 * Captured:  2026-06-25T08:39:03.935Z
 * Duration:  0ms
 * Derived:   files=[src/flow/compaction/index.ts, src/mcp/auto-setup.ts, src/orchestrator/orchestrator.ts, src/storage/index.ts, src/storage/transcript.ts, src/ui/slash/expand.ts, src/ui/use-app-logic.tsx, tests/harness/auto/smoke-boot.spec.ts] semanticIds=[(none)]
 *
