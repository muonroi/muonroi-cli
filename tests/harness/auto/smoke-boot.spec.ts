 ...
 *
 * Scenario:  smoke-boot
 * Captured:  2026-06-25T09:02:58.380Z
 * Duration:  0ms
 * Derived:   files=[src/orchestrator/subagent-compactor.spec.ts, src/orchestrator/subagent-compactor.ts, src/storage/__tests__/sweep-stale-pending.test.ts, src/storage/transcript.ts, src/tools/registry.ts, tests/harness/auto/smoke-boot.spec.ts] semanticIds=[(none)]
 *
