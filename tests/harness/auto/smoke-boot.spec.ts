 ...
 *
 * Scenario:  smoke-boot
 * Captured:  2026-06-25T11:53:18.981Z
 * Duration:  0ms
 * Derived:   files=[src/cli/cost-forensics.ts, src/orchestrator/orchestrator.ts, src/storage/__tests__/hierarchical-session.test.ts, src/storage/index.ts, src/storage/migrations.ts, src/storage/transcript.ts, src/storage/usage.ts, tests/harness/auto/smoke-boot.spec.ts] semanticIds=[(none)]
 *
