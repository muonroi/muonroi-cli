 ...
 *
 * Scenario:  smoke-boot
 * Captured:  2026-06-25T11:46:24.206Z
 * Duration:  0ms
 * Derived:   files=[src/generated/version.ts, src/orchestrator/orchestrator.ts, src/storage/__tests__/sweep-stale-pending.test.ts, src/storage/index.ts, src/storage/migrations.ts, src/storage/transcript.ts, src/tools/registry.ts, tests/harness/auto/smoke-boot.spec.ts] semanticIds=[(none)]
 *
