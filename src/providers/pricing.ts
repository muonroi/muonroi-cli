...
export const PRICING: Record<string, Record<string, PricePerMillion>> = {
  anthropic: {
    'claude-3-5-haiku-latest': { input_per_million_usd: 0.80, output_per_million_usd: 4.00 },   // anthropic.com/pricing
    'claude-3-5-sonnet-latest': { input_per_million_usd: 3.00, output_per_million_usd: 15.00 },  // anthropic.com/pricing
    'claude-3-opus-latest': { input_per_million_usd: 15.00, output_per_million_usd: 75.00 },     // anthropic.com/pricing
  },
  openai: {
    'gpt-4o': { input_per_million_usd: 2.50, output_per_million_usd: 10.00 },       // openai.com/api/pricing
    'gpt-4o-mini': { input_per_million_usd: 0.15, output_per_million_usd: 0.60 },    // openai.com/api/pricing
    'o1': { input_per_million_usd: 15.00, output_per_million_usd: 60.00 },           // openai.com/api/pricing
  },
  google: {
    'gemini-2.5-flash': { input_per_million_usd: 0.30, output_per_million_usd: 2.50 },    // ai.google.dev/pricing
    'gemini-pro-latest': { input_per_million_usd: 1.25, output_per_million_usd: 10.00 },   // ai.google.dev/pricing
  },
  deepseek: {
    'deepseek-chat': { input_per_million_usd: 0.27, output_per_million_usd: 1.10 },       // api-docs.deepseek.com
