...
- If you hit a tool execution limit, the CLI auto-compacts the context and lets you continue — keep working toward the goal; do NOT stop to tell the user to start a new session or run \`/compact\` themselves. Only if you have genuinely finished the task should you present your final answer.
