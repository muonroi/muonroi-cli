...
const mockInventory: ModelInfo[] = [
  { id: "gpt-4o", name: "GPT-4o", provider: "openai", tier: "premium" as any, contextWindow: 128000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
  { id: "gpt-4o-mini", name: "GPT-4o Mini", provider: "openai", tier: "balanced" as any, contextWindow: 128000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
  { id: "claude-3-5-sonnet", name: "Claude 3.5 Sonnet", provider: "anthropic", tier: "premium" as any, contextWindow: 200000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
  { id: "claude-3-haiku", name: "Claude 3 Haiku", provider: "anthropic", tier: "balanced" as any, contextWindow: 200000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
  { id: "o1", name: "o1", provider: "openai", tier: "premium" as any, contextWindow: 128000, inputPrice: 0, outputPrice: 0, reasoning: true, description: "" },
  { id: "o1-mini", name: "o1-mini", provider: "openai", tier: "balanced" as any, contextWindow: 128000, inputPrice: 0, outputPrice: 0, reasoning: true, description: "" },
  { id: "llama-3-70b", name: "Llama 3 70b", provider: "meta", tier: "balanced" as any, contextWindow: 8000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
  { id: "llama-3-8b", name: "Llama 3 8b", provider: "meta", tier: "fast" as any, contextWindow: 8000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
];
...
describe("role-registry resolution", () => {
  ...
  it("assigns different models on same provider when only one provider has enough models", async () => {
    ...
    const inventoryWith6Models: ModelInfo[] = [
      ...
      { id: "gpt-3.5-turbo", name: "GPT-3.5", provider: "openai", tier: "fast" as any, contextWindow: 16000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
      { id: "gpt-4-turbo", name: "GPT-4 Turbo", provider: "openai", tier: "premium" as any, contextWindow: 128000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
    ];
  ...
  it("refuses if single provider has only 5 models", async () => {
    const inventoryWith5Models: ModelInfo[] = mockInventory.filter(m => m.provider === "openai").concat([
      { id: "gpt-3.5-turbo", name: "GPT-3.5", provider: "openai", tier: "fast" as any, contextWindow: 16000, inputPrice: 0, outputPrice: 0, reasoning: false, description: "" },
    ]);
  ...
  it("applies EE override when provided and valid", async () => {
    const eeRouteOverride = async (slot: string) => {
      if (slot === "PO") {
        return { model: "claude-3-5-sonnet", tier: "premium", confidence: 1, source: "ee", reason: "override", taskHash: "123" };
      }
      return null;
    };
  ...
  it("ignores EE override if model is not in inventory", async () => {
    const eeRouteOverride = async (slot: string) => {
      if (slot === "PO") {
        return { model: "non-existent-model", tier: "premium", confidence: 1, source: "ee", reason: "override", taskHash: "123" };
      }
      return null;
    };
