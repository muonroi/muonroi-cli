...
describe("extractDecisions", () => {
  ...
  it("extracts Constraint: lines", async () => {
  ...
  it("extracts content inside preserve blocks as decisions", async () => {
    const messages: ModelMessage[] = [
      {
        role: "user",
  ...
  it("returns empty arrays for empty messages", async () => {
  ...
  it("extracts multiple patterns from a single message", async () => {
    const messages: ModelMessage[] = [
      {
        role: "user",
