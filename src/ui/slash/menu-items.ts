...
export const SLASH_MENU_ITEMS: SlashMenuItem[] = [
  ...
  { id: "config", label: "config", description: "Open provider and council configuration", hidden: true },
  { id: "remote-control", label: "remote-control", description: "Remote control", hidden: true },
  { id: "agents", label: "agents", description: "Manage custom sub-agents", hidden: true },
  { id: "schedule", label: "schedule", description: "View scheduled runs", hidden: true },
  ...
  { id: "sessions", label: "sessions", description: "List recent sessions to resume", hidden: true },
  ...
  { id: "skills", label: "skills", description: "Manage skills", hidden: true },
  { id: "btw", label: "btw", description: "Ask a side question without interrupting", hidden: true },
  ...
  { id: "ee-stats", label: "ee stats", description: "Knowledge base statistics", hidden: true },
  { id: "ee-gates", label: "ee gates", description: "Quality gate checklist", hidden: true },
  { id: "ee-evolve", label: "ee evolve", description: "Trigger EE evolution cycle", hidden: true },
  { id: "ee-user", label: "ee user", description: "Current EE user identity", hidden: true },
  { id: "ee-search", label: "ee search", description: "Semantic search across knowledge base", hidden: true },
  { id: "ee-timeline", label: "ee timeline", description: "Principle evolution for a topic", hidden: true },
  { id: "ee-graph", label: "ee graph", description: "Principle relationship graph", hidden: true },
  { id: "ee-route", label: "ee route", description: "Route task to workflow", hidden: true },
  { id: "ee-context-on", label: "ee-context on", description: "Enable BB-aware EE context injection", hidden: true },
