...
export interface InitNewFormState {
  step: "name" | "fe-stack" | "running" | "done" | "error";
    ...
    <Semantic id="init-new-form" role="dialog" name="Init new project">
      <box flexDirection="column" marginBottom={1}>
        ...
        >
          ...
          {/* Step 1: project name */}
          {(state.step === "name" || state.step === "fe-stack") && (
          ...
          {state.step === "running" && (
            <box flexDirection="column" marginTop={1}>
              ...
              <text fg={t.initFormHint}>Cloning muonroi-building-block + writing client skeleton…</text>
            </box>
          )}
          ...
          <text fg={t.initFormHint} marginTop={1}>
            ...
            {state.step === "fe-stack" && "↑↓ select · Enter confirm · Esc back"}
