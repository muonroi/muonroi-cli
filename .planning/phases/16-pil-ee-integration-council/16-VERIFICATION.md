...
| 14 | checkEEDetailed reports ee.health with mode/circuit/server sub-status (CQ-16c) | ✓ VERIFIED | `src/ops/doctor.ts:126-161` — checkEEDetailed uses healthDetailed(); name="ee.health"; VPS hint at "72.61.127.154:8082" |
