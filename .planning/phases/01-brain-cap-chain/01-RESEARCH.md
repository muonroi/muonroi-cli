...
| VPS Ollama (`experience.muonroi.com`) | Plan 03 warm path | unverified at research time | — | Local Ollama on `localhost:11434` works for plan 01 ollama provider tests |
