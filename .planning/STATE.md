...
- 2026-05-19: Milestone v1.9 "EE-driven Scaffold" added with Phase 23 (origin: user-reported scaffold failure in session 368eeee4b3f0 + brain probe at https://experience.muonroi.com confirming `bb-recipes` has structured `Template <name> (<short>): ... | uses: <pkg1>, <pkg2>, ...` entries already).
