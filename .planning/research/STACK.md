...
| Ollama (warm) | `ollama-ai-provider-v2@1.50.1` against `http://experience.muonroi.com:11434` | YES | Limited (model-dependent — qwen2.5-coder supports it) | Partial (no cost, just tokens) | Free tier, no $ tracking needed |
