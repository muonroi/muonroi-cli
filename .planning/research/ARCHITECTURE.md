...
└─────────┼──────────────────────────────────────────┼──────────────────┘
   ...
   │ (local 6333 │    │ experience.muonroi.com    │    │ OpenAI / Gemini /│
...
| Ollama (VPS) | HTTPS + SSE direct from TUI | Provider adapter | OpenAI-compatible endpoint at `experience.muonroi.com:11434`. No key (LAN-only or token via proxy). |
